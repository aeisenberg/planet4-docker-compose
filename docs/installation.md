...
```bash
com.docke  5086 andrew.eisenberg   84u  IPv6 0xdc100c215fbb6b93      0t0  TCP *:8080 (LISTEN)
```
...
8bb74e6d8537   containers.xxx.com/my-container:1.1          "/entrypoint.sh /usr…"   2 months ago    Up 10 minutes             0.0.0.0:8080->8080/tcp                           my-container_1
```

To stop the container, run:

```bash
docker kill 8bb74e6d8537
```
